...
M8MacroSynthParams = m8_object_class(
    field_map=[
        ...
        ("volume", 0x00, 15, 16, "UINT8"), 
        ("pitch", 0x00, 16, 17, "UINT8"), 
        ("fine_tune", 0x80, 17, 18, "UINT8"),
        ("shape", 0x00, 18, 19, "UINT8"),
        ("timbre", 0x80, 19, 20, "UINT8"),
        ("color", 0x80, 20, 21, "UINT8"),
        ("degrade", 0x00, 21, 22, "UINT8"),
        ("redux", 0x00, 22, 23, "UINT8"),
        ("filter_type", 0x00, 23, 24, "UINT8"),
        ("filter_cutoff", 0xFF, 24, 25, "UINT8"),
        ("filter_resonance", 0x00, 25, 26, "UINT8"),
        ("amp_level", 0x00, 26, 27, "UINT8"),
        ("amp_limit", 0x00, 27, 28, "UINT8"),
        ("mixer_pan", 0x80, 28, 29, "UINT8"),
        ("mixer_dry", 0xC0, 29, 30, "UINT8"),
        ("mixer_chorus", 0x00, 30, 31, "UINT8"),
        ("mixer_delay", 0x00, 31, 32, "UINT8"),
        ("mixer_reverb", 0x00, 32, 33, "UINT8")
    ]
)
