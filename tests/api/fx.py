...
class TestM8FXTuple(unittest.TestCase):
    def test_read_from_binary(self):
        ...
        self.assertEqual(fx_tuple.key, M8WavSynthFX.VOL.value)
        ...
        self.assertEqual(fx_tuple.key, M8SequencerFX.ARP.value)
        self.assertEqual(fx_tuple.value, 30)
    
    def test_write_to_binary(self):
        # Test case 1: Regular tuple with enum value
        fx_tuple = M8FXTuple(key=M8WavSynthFX.VOL.value, value=10)
    ...
    def test_read_write_consistency(self):
        ...
        test_cases = [
            (M8WavSynthFX.VOL.value, 20),  # WavSynth FX
            (M8SequencerFX.ARP.value, 30),  # Sequencer FX
    ...
    def test_constructor_and_defaults(self):
        ...
        fx_tuple = M8FXTuple(key=M8WavSynthFX.VOL.value, value=20)
        self.assertEqual(fx_tuple.key, M8WavSynthFX.VOL.value)
        self.assertEqual(fx_tuple.value, 20)
    ...
    def test_property_accessors(self):
        ...
        fx_tuple.key = M8WavSynthFX.VOL.value
        fx_tuple.value = 25
        ...
        self.assertEqual(fx_tuple.key, M8WavSynthFX.PAN.value)
    ...
    def test_as_dict(self):
        ...
        expected = {
            "key": M8WavSynthFX.VOL.value,  # Should be integer enum value
            "value": 20
        }
    ...
    def test_from_dict(self):
        ...
        original = M8FXTuple(key=M8SequencerFX.DEL.value, value=40)
...
class TestM8FXTuples(unittest.TestCase):
    def test_read_from_binary(self):
        ...
        self.assertEqual(fx_tuples[0].key, M8WavSynthFX.VOL.value)
        ...
        self.assertEqual(fx_tuples[2].key, M8SequencerFX.ARP.value)
    ...
    def test_write_to_binary(self):
        ...
        fx_tuples[0] = M8FXTuple(key=M8WavSynthFX.VOL.value, value=20)
        fx_tuples[2] = M8FXTuple(key=M8SequencerFX.ARP.value, value=40)
    ...
    def test_clone(self):
        # Test clone method
        original = M8FXTuples()
        original[0] = M8FXTuple(key=M8WavSynthFX.VOL.value, value=20)
        original[2] = M8FXTuple(key=M8SequencerFX.ARP.value, value=40)
        ...
        clone[0].key = M8WavSynthFX.CUT.value
        clone[0].value = 60
        self.assertEqual(original[0].key, M8WavSynthFX.VOL.value)
    ...
    def test_as_list(self):
        ...
        self.assertEqual(tuple0["key"], M8WavSynthFX.VOL.value)
        self.assertEqual(tuple0["value"], 20)
        
        tuple2 = next(t for t in result if t["index"] == 2)
        self.assertEqual(tuple2["key"], M8SequencerFX.ARP.value)
    ...
    def test_from_list(self):
        ...
        data = [
            {"index": 0, "key": M8WavSynthFX.VOL.value, "value": 20},
            {"index": 2, "key": M8SequencerFX.ARP.value, "value": 40}
        ]
        ...
        data = [
            {"index": BLOCK_COUNT + 5, "key": M8WavSynthFX.VOL.value, "value": 60}  # Out of range
        ]
